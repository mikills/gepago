...
func lifecycleExamples() []gepa.Example {
	return []gepa.Example{
		gepa.NewIOExample("positive-fast", gepa.Prediction{"text": "The team resolved my ticket fast."}, gepa.Prediction{"label": "positive"}),
		gepa.NewIOExample("positive-helpful", gepa.Prediction{"text": "Support was helpful and clear."}, gepa.Prediction{"label": "positive"}),
		gepa.NewIOExample("negative-broken", gepa.Prediction{"text": "The product broke on day one."}, gepa.Prediction{"label": "negative"}),
		gepa.NewIOExample("negative-late", gepa.Prediction{"text": "Delivery was late and nobody replied."}, gepa.Prediction{"label": "negative"}),
	}
}
